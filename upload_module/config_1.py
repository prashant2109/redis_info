class Config:
    ...
    sheet_schema  = "CREATE TABLE IF NOT EXISTS sheet_mgmt (template_id int(10) , template_name varchar(255), sheet_id int(10), sheet_name varchar(255), user varchar(255), datetime DATETIME DEFAULT CURRENT_TIMESTAMP, extra_info text)"
